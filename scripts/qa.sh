...
# Coverage can only be measured with Xdebug or PCOV. With no driver available we
# run the tests without it rather than fail: a partial guard beats a bypassed one.
